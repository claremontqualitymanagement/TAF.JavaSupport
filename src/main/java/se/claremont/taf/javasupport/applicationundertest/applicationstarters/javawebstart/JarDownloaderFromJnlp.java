...
public class JarDownloaderFromJnlp {
    ...
    private void downloadAndSaveJarFiles(String baseUrl, ArrayList<String> jarFiles) {
        ...
        log(LogLevel.DEBUG, "It took " + (System.currentTimeMillis() - startTime) / 1000 + " seconds to download all jar files.");
    }
    ...
    private void downloadAndSaveJarFile(String baseUrl, String jarFile) {
        ...
        log(LogLevel.DEBUG, "It took " + millis + " milliseconds to download '" + baseUrl + jarFile + "' to '" + baseFilePath + jarFile + "'.");
    }
}
