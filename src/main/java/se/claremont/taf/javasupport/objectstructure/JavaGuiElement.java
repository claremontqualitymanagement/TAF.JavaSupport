...
public class JavaGuiElement implements GuiComponent, Serializable, PositionBasedGuiElement {
    @JsonProperty
    public By by;
    @JsonProperty
    String name;
            ...
            switch (searchCondition.searchConditionType) {
                case CLASS:
                    for (Object o : componentList) {
                        if (!o.getClass().getSimpleName().equals(searchCondition.objects[0])) {
                            removeElements.add(o);
                        }
                    }
                    recognitionDescription.add("Removing " + removeElements.size() + " elements not being of class '" + searchCondition.objects[0] + "'.");
                ...
                case NAME:
                    for (Object o : componentList) {
                        ...
                        if (name == null || !name.equals(searchCondition.objects[0])) {
                            removeElements.add(o);
                        }
                    }
                    recognitionDescription.add("Removing " + removeElements.size() + " elements not being named '" + searchCondition.objects[0] + "'.");
                    returnElements.removeAll(removeElements);
                    removeElements.clear();
                    break;
                ...
                case EXACT_TEXT:
                    for (Object o : componentList) {
                        ...
                        for (Object acceptedText : searchCondition.objects) {
                            ...
                            if (elementText != null && elementText.equals(acceptedText)) {
                                toBeRemoved = false;
                                break;
                            }
                        }
                ...
                case TEXT_REGEX_MATCH:
                    ...
                    recognitionDescription.add("Removing " + removeElements.size() + " elements not matching pattern '" + searchCondition.objects[0] + "'.");
                    returnElements.removeAll(removeElements);
                    removeElements.clear();
                    break;
    ...
    public String toString() {
        ...
        description += "', cached object stored: " + (cachedElement != null) + "]";
        return description;
    }
