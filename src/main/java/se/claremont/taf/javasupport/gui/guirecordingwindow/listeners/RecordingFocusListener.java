...
public class RecordingFocusListener implements FocusListener {
    ...
    public void focusLost(FocusEvent e) {
        Object actualText = MethodInvoker.invokeTheFirstEncounteredMethodFromListOfMethodNames(e.getComponent(), MethodDeclarations.textGettingMethodsInAttemptOrder);
