...
public class ObjectToHtmlHelper {
    ...
    static HashSet<Class<?>> primitiveClassesSet = new HashSet<>(Arrays.asList(
            String.class,
            Integer.class,
            int.class,
            boolean.class,
    ...
    public static String toHtml(Object object, int depth) {
        ...
        if (returnAsPureText(object)) {
            String returnString = "";
            try {
                returnString = tab(depth) + object.toString().replace(System.lineSeparator(), "<br>" + System.lineSeparator());
            } catch (Exception e) {
