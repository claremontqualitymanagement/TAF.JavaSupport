...
public class PositionBasedTests extends UnitTestClass {
    ...
    public void getText() {
        ...
        Assert.assertTrue(java.getText(textField).equals("Cancel"));
        JavaTestApplicationRunner.hideWindow();
    }
    ...
    public void getText2() {
        ...
        JavaGuiElement textField = (JavaGuiElement) PositionBasedIdentificator.
                ...
                theObjectMostToTheRight();
        //java.takeScreenshot();
        Assert.assertTrue(java.getText(textField.getRuntimeComponent()), java.getText(textField.getRuntimeComponent()).equals("Cancel"));
        JavaTestApplicationRunner.hideWindow();
    }
